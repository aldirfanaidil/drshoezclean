...
export default function ReportsPage() {
  ...
  const shoeServiceChartData = useMemo(() => [
    ...
    { name: "Unyellowing", count: shoeServiceStats.unyellowing, fill: "hsl(200, 70%, 50%)" },
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="opacity-0 animate-fade-in" style={{ animationDelay: "0.5s" }}>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">Statistik Sepatu Masuk per Layanan</CardTitle>
        </CardHeader>
        <CardContent>
