...
export default function CashFlowPage() {
  ...
  // Available years from cashflow data
  ...
  const filteredCashFlows = useMemo(() => {
    return cashFlows
      .filter((cf) => {
        ...
        // Use relative period filter when no month/year is selected
        return isAfter(parseISO(cf.date), filterStartDate);
      })
  ...
  const paginatedCashFlows = useMemo(() => {
    ...
    return filteredCashFlows.slice(start, start + ITEMS_PER_PAGE);
  }, [filteredCashFlows, currentPage]);
