...
export default function UsersPage() {
  ...
  const { users, branches, addUser, updateUser, deleteUser, currentUser } = useAppStore();
  ...
  const handleUpdateUser = () => {
    ...
    const updates: Partial<User> = {
      ...
      role: formData.role,
      branchId: formData.branchId || undefined, // FIX: Tambahkan branchId ke updates
            ...
            {formData.role !== "superuser" && (
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setFormData({ ...formData, branchId: v === "all" ? "" : v })}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Pilih cabang" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">Semua Cabang (Akses Penuh)</SelectItem>
                ...
                <p className="text-xs text-muted-foreground">
                  User hanya bisa melihat data dari cabang yang dipilih
                </p>
              </div>
            )}
          </div>
